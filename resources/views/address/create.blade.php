    ...
    <div class="container-xl">
        <div class="row g-2 align-items-center">
            ...
            <div class="col-auto ms-auto d-print-none">
                <div class="btn-list">
                    <a href="{{ route('address') }}" class="btn btn-primary d-none d-sm-inline-block">
                        ...
                        <div class="row card-body">
                            <div class="col-6" id="col1">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('address') is-invalid @enderror" name="address" placeholder="192.168.100.1/24" />
                                    @error('address')
